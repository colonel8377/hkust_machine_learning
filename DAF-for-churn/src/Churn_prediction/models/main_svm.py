...
'''
Basic
test_auc 0.834549648627474
test_acc 0.8342717258261934
f1_score 0.8456599041534263
-------
Basic+DIF
test_auc 0.8785444791290082
test_acc 0.8753977968176254
f1_score 0.8809997637574544
-------

'''


def SVM(feature_file):
    datapath = "../../data"
    ...
    for fold in range(1, 6):
        ...
        result = svc.predict(X_val)
        try:
            prob = svc.predict_proba(X_val)[:, 1]
        except:
            prob = result
    ...
    with open("results/SVM/SVM_" + train_type + "_results.txt", "w") as F:
...
if __name__ == "__main__":
    SVM("Churn-Features/feature_data.csv")
    SVM("Churn-Features/feature_data_diff.csv")
    SVM("Churn-Features/feature_data_all_fold-XXX.csv")

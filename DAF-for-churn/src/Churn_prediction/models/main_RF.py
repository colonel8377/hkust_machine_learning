...
def RF(estimators, max_depth, feature_file):
    datapath = "../../data"
    ...
    with open("results/RF/RF_" + train_type + "_results.txt", "w") as F:
...
if __name__ == "__main__":
    RF(500, 12, "Churn-Features/feature_data.csv")
    RF(500, 12, "Churn-Features/feature_data_diff.csv")
    RF(700, 14, "Churn-Features/feature_data_all_fold-XXX.csv")
